...
const NoMessages: React.FC = () => {
  return (
    <div className='flex mt-[110px] w-[832px] h-[392px] justify-center gap-12 items-center flex-col m-auto'>
        <div>
      ...
      <div className='mt-12'>
        <p className='text-2xl font-bold text-center'>It’s the beginning of a legendary sales pipeline </p>
        <p className='text-[#9E9E9E] text-lg font-medium mt-6 text-center'>When you have inbound E-mails <br /> you’ll see them here</p>
      </div>
    </div>
  )
}
