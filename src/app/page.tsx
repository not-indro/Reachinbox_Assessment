        ...
        <div className='w-auto flex justify-center items-center'>
          <div className=' m-auto w-[460px] h-auto md:h-[312px]  bg-[#111214] rounded-2xl border border-gray-700  py-6  px-10 '>
            <div className=' w-[380px] m-auto'>
              ...
              <Link href={"https://hiring.reachinbox.xyz/api/v1/auth/google-login?redirect_to=reachinbox-assessment-pn8aixm3q-indranil-bains-projects.vercel.app/dashboard"}>
